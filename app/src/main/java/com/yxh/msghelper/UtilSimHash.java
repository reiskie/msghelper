...
public class UtilSimHash {
    private static final String TAG = "UtilSimHash";
    ...
    public UtilSimHash(String tokens) {
        this.tokens = tokens;
        this.strSimHash = this.simHash();
    }

    private UtilSimHash(String tokens, int hashbits) {
        this.tokens = tokens;
     ...
     * @return
     */
    private int hammingDistance(UtilSimHash other) {
    ...
    public double getSemblance(UtilSimHash s2 ){
    ...
    public static int getSimilarityPercent(String s1, String s2){
        ...
        Log.i(TAG,"getSimilarityPercent：s1: " + s1);
        Log.i(TAG,"getSimilarityPercent：s2: " + s2);

        UtilSimHash hh1 = new UtilSimHash(s1, 64);
        UtilSimHash hh2 = new UtilSimHash(s2, 64);
        //System.out.println("海明距离是:" + hh1.hammingDistance(hh2) );
        res = (int)(hh1.getSemblance(hh2) * 100);
        Log.i(TAG,"文本相似度:" + res + "%" );
